...
document.querySelectorAll(".fas.fa-pen").forEach((e) => {
  e.addEventListener("click", () => {
    e.parentElement.parentElement.children[0].children[0].removeAttribute(
      "readonly"
    );
  });
});
document.querySelectorAll("input").forEach((e) => {
  e.addEventListener("input", () => {
    if (document.querySelector(".button button").hasAttribute("disabled")) {
